...
def main(raw_data, preprocessed_data, preprocessor_loc, seed):
    ...
    X_train.to_csv(os.path.join(preprocessed_data,'X_train.csv'))
    y_train.to_csv(os.path.join(preprocessed_data,'y_train.csv'))
    X_test.to_csv(os.path.join(preprocessed_data,'X_test.csv'))
    y_test.to_csv(os.path.join(preprocessed_data,'y_test.csv'))
